...
@Component({
    ...
    templateUrl: './pregledUplata.component.html'
})
export class PregledUplataComponent {
  datumOd: Date;
  datumDo: Date;
  ...
  ok() {
    this.http.get(this.baseUrl + 'ugovor/pregledUplata?datumOd=' + this.datumOd + "&datumDo=" + this.datumDo
      , {
